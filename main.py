...
def get_stock_analysis(ticker):
    ...
    try:
        ...
        # 1. Latest PE Ratio and PEG Ratio
...
def main():
    ...
    print("This tool provides comprehensive financial analysis and health check for any stock ticker.")
    ...
    while True:
        ...
        print(f"\nRunning detailed analysis for {ticker}...")
        get_stock_analysis(ticker)
        
        # Run financial health checker
        try:
            from financial_health_console import FinancialHealthChecker
            print(f"\nRunning financial health check for {ticker}...")
            checker = FinancialHealthChecker()
            checker.analyze_stock(ticker)
        except ImportError:
            print("Error: Financial Health Checker module not found.")
        except Exception as e:
            print(f"Error running Financial Health Checker: {str(e)}")
